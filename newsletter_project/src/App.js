...
import Pause from '@mui/icons-material/PlayArrow';
import PlayArrow from '@mui/icons-material/PlayArrow';
import ExpandMoreIcon from '@mui/icons-material/ExpandMore';

// button courtesy of https://mui.com/material-ui/react-button/
import Button from '@mui/material/Button';

export default function App() {
  // speech to text courtesy of https://www.assemblyai.com/blog/react-text-to-speech-simplified/
  ...
  return (
    ...
    <header className = "App-header">
      ...
      <Box sx={{ width: '99%', position: 'fixed'}}>
        <Button 
          variant="contained" 
