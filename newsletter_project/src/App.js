...
// courtesy of https://cloud.google.com/text-to-speech/docs/samples/tts-synthesize-text
...
const audio_src = 'transcript.mp3';
...
await writeFile(audio_src, response.audioContent, 'binary');